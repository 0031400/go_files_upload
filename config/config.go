...
func Init() {
	...
	webdavPathFlag := flag.String("s", "http://127.0.0.1:6065/one/", "the webdav server path")
	webdavUsernameFlag := flag.String("u", "admin", "the webdav server username")
	WebdavPasswordFlag := flag.String("p", "admin", "the webdav server password")
